...
/* Generated: 2026-02-27T15:49:00.797394 */
...
export interface ProviderPluginPolicy {
    ...
    communityWarningAccepted?: boolean;
}
...
export interface ProviderPluginSourceInfo {
    ...
    pluginPath?: string | undefined;
    blockedByPolicy?: boolean;
    requiresCommunityWarning?: boolean;
    installed?: boolean;
}
...
export class EventsSocket {
    ...
    onWorkspaceFilesChanged(callback: (data: WorkspaceFilesChanged) => void): () => void {
        return this.on("workspace_files_changed", (_d) => { const _raw = _d as any; return callback({ chatId: _raw.chat_id, changedPaths: _raw.changed_paths, deletedPaths: _raw.deleted_paths }); });
    }
