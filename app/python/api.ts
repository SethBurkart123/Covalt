...
/* Generated: 2025-12-12T19:43:13.130474 */
...
function convertChatEvent(obj: ChatEvent): Record<string, unknown> {
    return {
        event: obj.event,
        content: obj.content,
 ...
 */
export function continueMessage(args: { messageId: string; chatId: string; modelId?: string }): BridgeChannel<ChatEvent> {
    return createChannel("continue_message", { messageId: args.messageId, chatId: args.chatId, modelId: args.modelId });
}
 ...
 */
export function editUserMessage(args: { messageId: string; newContent: string; chatId: string; modelId?: string }): BridgeChannel<ChatEvent> {
    return createChannel("edit_user_message", { messageId: args.messageId, newContent: args.newContent, chatId: args.chatId, modelId: args.modelId });
}
 ...
 */
export function retryMessage(args: { messageId: string; chatId: string; modelId?: string }): BridgeChannel<ChatEvent> {
    return createChannel("retry_message", { messageId: args.messageId, chatId: args.chatId, modelId: args.modelId });
}
...
export function streamChat(args: { messages: Record<string, unknown>[]; modelId?: string; chatId?: string }): BridgeChannel<ChatEvent> {
    return createChannel("stream_chat", { messages: args.messages, modelId: args.modelId, chatId: args.chatId });
}
