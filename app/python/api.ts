...
/* Generated: 2026-03-06T10:20:37.393234 */
...
export interface EnableProviderPluginInput {
    id: string;
    enabled: boolean;
}
...
export async function enableProviderPlugin(args: { body: EnableProviderPluginInput }): Promise<Record<string, boolean>> {
    return request("enable_provider_plugin", { body: args.body });
}
