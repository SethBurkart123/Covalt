...
/* Generated: 2025-12-12T19:08:20.327241 */
...
export async function continueMessage(args: { body: ContinueMessageRequest }): Promise<void> {
    return request("continue_message", { body: convertContinueMessageRequest(args.body) });
}
...
export async function editUserMessage(args: { body: EditUserMessageRequest }): Promise<void> {
    return request("edit_user_message", { body: convertEditUserMessageRequest(args.body) });
}
...
export async function retryMessage(args: { body: RetryMessageRequest }): Promise<void> {
    return request("retry_message", { body: convertRetryMessageRequest(args.body) });
}
...
export async function streamChat(args: { body: StreamChatRequest }): Promise<void> {
    return request("stream_chat", { body: convertStreamChatRequest(args.body) });
}
