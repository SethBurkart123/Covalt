...
/* Generated: 2026-02-06T16:57:34.215341 */
...
export async function listAgents(): Promise<AgentsListResponse> {
    ...
    return { agents: _r.agents.map((item: unknown) => ({ id: item.id, name: item.name, description: item.description, icon: item.icon, previewImage: item.preview_image, createdAt: item.created_at, updatedAt: item.updated_at })) };
}
