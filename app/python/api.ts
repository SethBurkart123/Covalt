...
/* Generated: 2026-01-18T16:18:30.770197 */
...
export async function getToolset(args: { body: ToolsetIdRequest }): Promise<ToolsetDetailInfo> {
    ...
    return { id: _r.id, name: _r.name, version: _r.version, description: _r.description, enabled: _r.enabled, installedAt: _r.installed_at, sourceType: _r.source_type, toolCount: _r.tool_count, tools: _r.tools.map((item: unknown) => ({ toolId: item.tool_id, name: item.name, description: item.description, requiresConfirmation: item.requires_confirmation, enabled: item.enabled })) };
}
