...
/* Generated: 2026-02-13T19:01:02.033968 */
...
export interface AgentLastExecutionResponse {
...
export interface FlowNodeExecutionSnapshot {
    ...
    nodeType?: string | undefined;
    status: unknown;
    outputs?: Record<string, FlowOutputPortSnapshot> | undefined;
...
export async function getAgentLastExecution(args: { body: AgentIdRequest }): Promise<AgentLastExecutionResponse> {
    return request("get_agent_last_execution", { body: args.body });
}
