...
/* Generated: 2025-12-14T12:05:51.702331 */
...
function convertAllModelSettingsResponse(
  obj: AllModelSettingsResponse,
...
function convertAllProvidersResponse(
  obj: AllProvidersResponse,
): Record<string, unknown> {
  return {
...
function convertAutoTitleSettings(
  obj: AutoTitleSettings,
): Record<string, unknown> {
  return {
    enabled: obj.enabled,
    prompt: obj.prompt,
...
function convertAvailableModelsResponse(
  obj: AvailableModelsResponse,
): Record<string, unknown> {
  return {
...
function convertAvailableToolsResponse(
  obj: AvailableToolsResponse,
): Record<string, unknown> {
  return {
...
function convertCancelRunRequest(
  obj: CancelRunRequest,
): Record<string, unknown> {
  return {
...
function convertChatAgentConfigResponse(
  obj: ChatAgentConfigResponse,
): Record<string, unknown> {
  return {
    toolIds: obj.toolIds,
    provider: obj.provider,
...
function convertChatMessage(obj: ChatMessage): Record<string, unknown> {
  return {
    ...
    toolCalls:
      obj.toolCalls != null
        ? obj.toolCalls.map(convertToolCall)
        : obj.toolCalls,
  };
}
...
function convertContinueMessageRequest(
  obj: ContinueMessageRequest,
): Record<string, unknown> {
  return {
    messageId: obj.messageId,
    chatId: obj.chatId,
...
function convertCreateChatInput(obj: CreateChatInput): Record<string, unknown> {
  return {
    ...
    model: obj.model,
    agentConfig:
      obj.agentConfig != null
        ? convertAgentConfig(obj.agentConfig)
        : obj.agentConfig,
  };
}

function convertDefaultToolsResponse(
  obj: DefaultToolsResponse,
): Record<string, unknown> {
  return {
    toolIds: obj.toolIds,
  };
...
function convertEditUserMessageRequest(
  obj: EditUserMessageRequest,
): Record<string, unknown> {
  return {
    messageId: obj.messageId,
...
function convertGetMessageSiblingsRequest(
  obj: GetMessageSiblingsRequest,
): Record<string, unknown> {
  return {
    messageId: obj.messageId,
  };
...
function convertMessageSiblingInfo(
  obj: MessageSiblingInfo,
): Record<string, unknown> {
  return {
    id: obj.id,
...
function convertModelSettingsInfo(
  obj: ModelSettingsInfo,
): Record<string, unknown> {
  return {
    provider: obj.provider,
    modelId: obj.modelId,
    ...
    thinkingTagPrompted:
      obj.thinkingTagPrompted != null
        ? convertThinkingTagPromptInfo(obj.thinkingTagPrompted)
        : obj.thinkingTagPrompted,
  };
}
...
function convertReprocessMessageRequest(
  obj: ReprocessMessageRequest,
): Record<string, unknown> {
  return {
    messageId: obj.messageId,
  };
...
function convertRespondToThinkingTagPromptInput(
  obj: RespondToThinkingTagPromptInput,
): Record<string, unknown> {
  return {
    provider: obj.provider,
    modelId: obj.modelId,
...
function convertRespondToToolApprovalInput(
  obj: RespondToToolApprovalInput,
): Record<string, unknown> {
  return {
    approvalId: obj.approvalId,
...
function convertRetryMessageRequest(
  obj: RetryMessageRequest,
): Record<string, unknown> {
  return {
    messageId: obj.messageId,
    chatId: obj.chatId,
...
function convertSaveAutoTitleSettingsInput(
  obj: SaveAutoTitleSettingsInput,
): Record<string, unknown> {
  return {
    enabled: obj.enabled,
    prompt: obj.prompt,
...
function convertSaveModelSettingsInput(
  obj: SaveModelSettingsInput,
): Record<string, unknown> {
  return {
    provider: obj.provider,
    modelId: obj.modelId,
    ...
    reasoning:
      obj.reasoning != null
        ? convertReasoningInfo(obj.reasoning)
        : obj.reasoning,
  };
}

function convertSaveProviderConfigInput(
  obj: SaveProviderConfigInput,
): Record<string, unknown> {
  return {
    provider: obj.provider,
    apiKey: obj.apiKey,
...
function convertSetDefaultToolsInput(
  obj: SetDefaultToolsInput,
): Record<string, unknown> {
  return {
    toolIds: obj.toolIds,
  };
...
function convertStreamChatRequest(
  obj: StreamChatRequest,
): Record<string, unknown> {
  return {
...
function convertSwitchToSiblingRequest(
  obj: SwitchToSiblingRequest,
): Record<string, unknown> {
  return {
    messageId: obj.messageId,
...
function convertThinkingTagPromptInfo(
  obj: ThinkingTagPromptInfo,
): Record<string, unknown> {
  return {
...
function convertToggleChatToolsInput(
  obj: ToggleChatToolsInput,
): Record<string, unknown> {
  return {
    chatId: obj.chatId,
    toolIds: obj.toolIds,
...
function convertUpdateChatModelInput(
  obj: UpdateChatModelInput,
): Record<string, unknown> {
  return {
    chatId: obj.chatId,
    provider: obj.provider,
 ...
 */
export function continueMessage(args: {
  body: ContinueMessageRequest;
}): BridgeChannel<unknown> {
  return createChannel("continue_message", {
    body: convertContinueMessageRequest(args.body),
  });
}
 ...
 */
export function editUserMessage(args: {
  body: EditUserMessageRequest;
}): BridgeChannel<unknown> {
  return createChannel("edit_user_message", {
    body: convertEditUserMessageRequest(args.body),
  });
}
 ...
 */
export async function getChatAgentConfig(args: {
  body: ChatId;
}): Promise<ChatAgentConfigResponse> {
 ...
 */
export async function getMessageSiblings(args: {
  body: GetMessageSiblingsRequest;
}): Promise<MessageSiblingInfo[]> {
  return request("get_message_siblings", {
    body: convertGetMessageSiblingsRequest(args.body),
  });
}
 ...
 */
export async function reprocessMessageThinkTags(args: {
  body: ReprocessMessageRequest;
}): Promise<unknown> {
  return request("reprocess_message_think_tags", {
    body: convertReprocessMessageRequest(args.body),
  });
}
 ...
 */
export async function respondToThinkingTagPrompt(args: {
  body: RespondToThinkingTagPromptInput;
}): Promise<void> {
  return request("respond_to_thinking_tag_prompt", {
    body: convertRespondToThinkingTagPromptInput(args.body),
  });
}
 ...
 */
export async function respondToToolApproval(args: {
  body: RespondToToolApprovalInput;
}): Promise<unknown> {
  return request("respond_to_tool_approval", {
    body: convertRespondToToolApprovalInput(args.body),
  });
}
...
export function retryMessage(args: {
  ...
  return createChannel("retry_message", {
    body: convertRetryMessageRequest(args.body),
  });
}
 ...
 */
export async function saveAutoTitleSettings(args: {
  body: SaveAutoTitleSettingsInput;
}): Promise<void> {
  return request("save_auto_title_settings", {
    body: convertSaveAutoTitleSettingsInput(args.body),
  });
}
...
export async function saveModelSettings(args: {
  body: SaveModelSettingsInput;
}): Promise<void> {
  return request("save_model_settings", {
    body: convertSaveModelSettingsInput(args.body),
  });
}
...
export async function saveProviderSettings(args: {
  body: SaveProviderConfigInput;
}): Promise<void> {
  return request("save_provider_settings", {
    body: convertSaveProviderConfigInput(args.body),
  });
}
 ...
 */
export async function setDefaultTools(args: {
  body: SetDefaultToolsInput;
}): Promise<void> {
  return request("set_default_tools", {
    body: convertSetDefaultToolsInput(args.body),
  });
}
...
export function streamChat(args: {
  ...
  return createChannel("stream_chat", {
    body: convertStreamChatRequest(args.body),
  });
}
 ...
 */
export async function switchToSibling(args: {
  body: SwitchToSiblingRequest;
}): Promise<void> {
  return request("switch_to_sibling", {
    body: convertSwitchToSiblingRequest(args.body),
  });
}
 ...
 */
export async function toggleChatTools(args: {
  body: ToggleChatToolsInput;
}): Promise<void> {
  return request("toggle_chat_tools", {
    body: convertToggleChatToolsInput(args.body),
  });
}
...
export async function updateChatModel(args: {
  body: UpdateChatModelInput;
}): Promise<void> {
  return request("update_chat_model", {
    body: convertUpdateChatModelInput(args.body),
  });
}
