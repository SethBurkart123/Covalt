...
from . import node_provider as _node_provider

EnableNodeProviderPluginInput = _node_provider.EnableNodeProviderPluginInput
InstallNodeProviderPluginFromDirectoryInput = _node_provider.InstallNodeProviderPluginFromDirectoryInput
InstallNodeProviderPluginFromRepoInput = _node_provider.InstallNodeProviderPluginFromRepoInput
NodeProviderCapabilityFlags = _node_provider.NodeProviderCapabilityFlags
NodeProviderDefinitionsResponse = _node_provider.NodeProviderDefinitionsResponse
NodeProviderNodeDefinition = _node_provider.NodeProviderNodeDefinition
NodeProviderPluginIdInput = _node_provider.NodeProviderPluginIdInput
NodeProviderPluginInfo = _node_provider.NodeProviderPluginInfo
NodeProviderPluginsResponse = _node_provider.NodeProviderPluginsResponse
NodeProviderRouteConfig = _node_provider.NodeProviderRouteConfig
NodeProviderRouteEntry = _node_provider.NodeProviderRouteEntry
...
class AutoTitleSettings(BaseModel):
    enabled: bool = True
    prompt: str = (
        "Generate a brief, descriptive title (max 6 words) for this conversation based on the user's message: "
