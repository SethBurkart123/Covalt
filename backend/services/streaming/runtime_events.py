...
EVENT_TOOL_CALL_PROGRESS = RUNTIME_EVENT_BY_KEY["TOOL_CALL_PROGRESS"]
EVENT_WORKING_STATE_CHANGED = RUNTIME_EVENT_BY_KEY["WORKING_STATE_CHANGED"]
EVENT_TOKEN_USAGE = RUNTIME_EVENT_BY_KEY["TOKEN_USAGE"]
EVENT_STREAM_WARNING = RUNTIME_EVENT_BY_KEY["STREAM_WARNING"]
EVENT_APPROVAL_REQUIRED = RUNTIME_EVENT_BY_KEY["APPROVAL_REQUIRED"]
EVENT_APPROVAL_RESOLVED = RUNTIME_EVENT_BY_KEY["APPROVAL_RESOLVED"]
